...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-text-primary-dark">Editar Categoría</h1>
    ...
    <div class="bg-surface rounded-lg border border-main p-6 max-w-lg">
        <form id="form-categoria" action="{{ route('categorias.update', $categoria) }}" method="POST" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea
                    ...
                    class="w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors resize-none input-main
            ...
            <div class="flex items-center gap-3">
                <button
                    type="submit"
                    aria-label="Actualizar categoría"
...
@vite('resources/js/categorias/validate.js')
@endsection
