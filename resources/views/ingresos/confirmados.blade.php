...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-text-primary-dark">Ingresos Confirmadoshi</h1>
    ...
    @if($ingresos->isEmpty())
        <div class="text-center py-12 text-gray-500 text-sm">No hay ingresos confirmados.</div>
    @else
