...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-text-primary-dark">Ingresos Pendientes</h1>
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('ingresos.confirmados') }}"
               aria-label="Listado de ingresos culminados"
               class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-text-primary-dark text-sm font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-slate-700 transition-colors">
                ...
                Listado de ingresos culminados
            </a>
        </div>
    </div>
    ...
    @if($ingresos->isEmpty())
        <div class="text-center py-12 text-gray-500 text-sm">No hay ingresos pendientes.</div>
    @else
                    ...
                    @foreach($ingresos as $ingreso)
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                            ...
                            <td class="px-6 py-8 whitespace-nowrap text-sm">
                                <a href="{{ route('ingresos.confirmar', $ingreso) }}"
                                   aria-label="Abrir ticket de ingreso"
