...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-text-primary-dark">Crear automotor</h1>
    ...
    <div class="bg-surface rounded-lg border border-main p-6 max-w-lg">
        <form id="form-automotor" action="{{ route('automotores.store') }}" method="POST" novalidate>
            @csrf
            ...
            <div class="flex items-center gap-3">
                <button
                    type="submit"
                    aria-label="Guardar nuevo automotor"
