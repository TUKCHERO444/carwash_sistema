...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-text-primary-dark">Nuevo Lavado</h1>
    ...
    <div class="bg-surface rounded-lg border border-main p-6">
        <form id="form-lavado" action="{{ route('lavados.store') }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
...
@vite('resources/js/lavados/create.js')
@endsection
