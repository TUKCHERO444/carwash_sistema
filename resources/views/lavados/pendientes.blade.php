...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-text-primary-dark">Lavados Pendientes</h1>
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('lavados.confirmados') }}"
               aria-label="Listado de lavados culminados"
    ...
    @if($lavados->isEmpty())
        <div class="text-center py-12 text-gray-500 text-sm">No hay lavados pendientes.</div>
    @else
                    ...
                    @foreach($lavados as $lavado)
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                            ...
                            <td class="px-6 py-8 whitespace-nowrap text-sm">
                                <a href="{{ route('lavados.confirmar', $lavado) }}"
                                   aria-label="Abrir ticket de lavado"
