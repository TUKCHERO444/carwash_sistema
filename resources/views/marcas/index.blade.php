...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-text-primary-dark">Marcas</h1>
                    ...
                    @foreach($marcas as $marca)
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                            ...
                            <td class="px-6 py-8 whitespace-nowrap text-sm flex items-center gap-2">
                                ...
                                <form method="POST" action="{{ route('marcas.destroy', $marca) }}" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
                                            aria-label="Eliminar marca {{ $marca->nombre }}"
                                            data-confirm="¿Estás seguro de eliminar esta marca?"
