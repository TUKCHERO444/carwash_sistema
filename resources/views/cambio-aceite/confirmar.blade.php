        ...
        <form id="form-cambio-aceite" action="{{ route('cambio-aceite.procesarConfirmacion', $cambioAceite) }}" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-5">
                ...
                <textarea
                    ...
                    class="w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors input-main {{ $errors->has('descripcion') ? 'border-red-400 bg-red-50 dark:bg-red-900/20' : '' }}"
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    name="foto"
                    accept="image/*"
                    class="w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors input-main {{ $errors->has('foto') ? 'border-red-400 bg-red-50 dark:bg-red-900/20' : '' }}"
                >
                ...
                <div class="grid grid-cols-2 gap-2 sm:grid-cols-3">
                    @foreach($trabajadores as $trabajador)
                        <label class="flex items-center gap-2 px-3 py-2 border rounded-lg cursor-pointer transition-colors hover:bg-gray-50 dark:hover:bg-slate-800/50
                                      {{ in_array($trabajador->id, $trabajadoresCheck) ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30' : 'border-main' }}
                                      trabajador-option">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="w-full pl-8 pr-3 py-2 border rounded-lg text-sm bg-slate-50 dark:bg-slate-800/50 focus:outline-none input-main {{ $errors->has('total') ? 'border-red-400 bg-red-50 dark:bg-red-900/20' : '' }}"
                        >
                    </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        @foreach(['efectivo' => 'Efectivo', 'yape' => 'Yape', 'izipay' => 'Izipay', 'mixto' => 'Mixto'] as $val => $label)
                            <label class="flex items-center gap-2 px-3 py-2 border rounded-lg cursor-pointer transition-colors metodo-pago-option {{ old('metodo_pago', $cambioAceite->metodo_pago ?? 'efectivo') === $val ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-main' }}">
                                <input
                                    type="radio"
                                    name="metodo_pago"
                                    value="{{ $val }}"
                ...
                <div id="bloque-mixto" class="hidden space-y-3">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-3 py-2 border rounded-lg text-sm input-main focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
                    </div>
                    <div>
            ...
            <div class="flex flex-wrap items-center gap-3 mt-6 pt-6 border-t border-main">
                ...
                <button
                    type="button"
                    onclick="toggleFacturacion(this)"
                    data-facturacion="off"
