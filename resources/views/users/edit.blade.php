...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-text-primary-dark">Editar usuario</h1>
    ...
    <div class="bg-surface rounded-lg border border-main p-6 max-w-lg">
        <form id="form-usuario" action="{{ route('users.update', $user) }}" method="POST" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="mb-5">
                ...
                >
                <p class="mt-1 text-xs text-gray-500">Dejar en blanco para conservar la contraseña actual</p>
                @error('password')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                @enderror
            </div>
