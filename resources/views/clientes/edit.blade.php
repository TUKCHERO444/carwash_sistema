...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-text-primary-dark">Editar cliente</h1>
    ...
    <div class="bg-surface rounded-lg border border-main p-6 max-w-lg">
        <form id="form-cliente" action="{{ route('clientes.update', $cliente) }}" method="POST" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center gap-3">
                <button
                    type="submit"
                    aria-label="Guardar cambios del cliente"
