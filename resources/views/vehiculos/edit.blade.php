...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-text-primary-dark">Editar vehículo</h1>
        ...
        <form action="{{ route('vehiculos.update', $vehiculo) }}" method="POST" novalidate>
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    id="nombre"
                    name="nombre"
                    value="{{ old('nombre', $vehiculo->nombre) }}"
                    autocomplete="off"
            ...
            <div class="mb-5">
                ...
                >{{ old('descripcion', $vehiculo->descripcion) }}</textarea>
            </div>
            ...
            <div class="flex items-center gap-3">
                <button
                    type="submit"
                    aria-label="Guardar cambios del vehículo"
