/**
 * resources/js/lavados/shared.js
 *
 * Lógica compartida entre lavados/create.js, lavados/edit.js e lavados/confirmar.js.
...
async function _buscarServicios(q, resultadosDiv, onAgregar) {
    const res  = await fetch(`/lavados/buscar-servicios?q=${encodeURIComponent(q)}`);
